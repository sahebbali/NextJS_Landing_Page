...
const Teacher = () => {
  return (
    <div className="container mx-auto py-20">
      <p className="text-base lg:text-xl text-center font-medium text-gray-500 uppercase">
       Key Person
      </p>
      <p className="text-3xl lg:text-5xl text-center font-semibold text-gray-500  mt-3">
      Meet our teachers
      </p>
