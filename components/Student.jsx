...
const Student = () => {
  return (
    <div className="container mx-auto ">
      <p className="text-gray-500 text-base text-center lg:text-xl font-medium uppercase">
        Top Studying
      </p>
      <p className="text-gray-800 text-center text-3xl lg:text-5xl font-medium capitalize">
        Our students say
      </p>
